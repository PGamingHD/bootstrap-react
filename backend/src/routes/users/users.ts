...
router.get("/", validateAuth, async (req: Request, res: Response): Promise<Response<any, Record<string, any>>> => {
...
router.put("/updateRole", validateAuth, async (req: Request, res: Response):  Promise<Response<any, Record<string, any>>> => {
    if (!process.env.MYSQL_PORT) return res.send({message: 'failed', response: 'Failed to find MySQL Connection Port!'});
...
router.delete("/removeUser/:username", validateAuth, async (req: Request, res: Response):  Promise<Response<any, Record<string, any>>> => {
    if (!process.env.MYSQL_PORT) return res.send({message: 'failed', response: 'Failed to find MySQL Connection Port!'});
